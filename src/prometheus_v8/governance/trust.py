...
from prometheus_v8.schema import TrustLevel, ActionHook, Node
...
class TrustManager:
    ...
    def __init__(self, high_signal_sources: int = 2, verified_usage_count: int = 1,
                 stale_days: int = 30, stale_utility_threshold: int = 2) -> None:
