...
from prometheus_v8.schema import Node, create_curiosity_node
...
class CuriosityQueue:
    ...
    def stats(self) -> dict[str, Any]:
        with self._lock:
            ...
            return {"total": len(self._queue), "pending": pending,
                    "explored": self._explored_count, "max_size": self._max_size}
