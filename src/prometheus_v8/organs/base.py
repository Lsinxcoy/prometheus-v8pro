...
class LLMClient:
    ...
    def __init__(self, api_base: str = "https://openrouter.ai/api/v1",
                 api_key: str = "", model: str = "qwen/qwen3-235b-a22b:free",
        ...
        for model in models:
            for attempt in range(self._max_retries):
                try:
                    ...
                    resp = self._client.post(f"{self._api_base}/chat/completions",
...
class BaseOrgan(ABC):
    ...
    def stats(self) -> dict[str, Any]:
        return {"name": self._name, "executions": self._execution_count,
                "total_time": self._total_time, "avg_time": self._total_time / max(1, self._execution_count)}
