...
class WeibullRetentionCalculator:
    ...
    def compute(self, age_days: float, importance: float, lam: float, k: float,
                consecutive_hits: int = 0, access_count: int = 0) -> WeibullMemoryScore:
        ...
        composite = importance * raw_retention * importance_factor * recall_reinforcement / importance_factor
