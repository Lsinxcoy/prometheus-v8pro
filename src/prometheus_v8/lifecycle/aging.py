...
class AgingDetector:
    ...
    def __init__(self, store=None) -> None:
        self._store = store
        self._reports: list[AgingReport] = []
    ...
    def assess(self, node: Node, similar_nodes: list[Node] | None = None) -> AgingReport:
        ...
        # Composite
        report.composite_aging = (0.2 * report.compression_aging + 0.3 * report.interference_aging +
                                  0.2 * report.revision_aging + 0.3 * report.maintenance_aging)
